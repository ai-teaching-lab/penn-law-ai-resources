...
- `index.html` — the whole portal: a six-tab layout (Getting Started · Agentic AI · Use Cases · Tools · Policies · AI at Penn) with inline CSS/JS and a Cmd+K site search. Self-contained.
